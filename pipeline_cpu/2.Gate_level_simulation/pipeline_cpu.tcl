...
#/*5. Write out file */
report_area > ./pipeline_cpu_syn.report
report_timing -path full -delay max >> ./pipeline_cpu_syn.report
report_power >> ./pipeline_cpu_syn.report
report_cell > ./pipeline_cpu_cells.report

#/* Write out netlist */
write -format verilog -hierarchy -output ./pipeline_cpu_syn.v
write -format verilog -hierarchy -output ../3.Post_layout_Simulation/APR/design_data/pipeline_cpu_syn.v
