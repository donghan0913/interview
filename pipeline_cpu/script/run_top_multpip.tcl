...
# /* Read Verilog files */
analyze ./rtl -autoread -format verilog -define {MULT_PIP}
elaborate top
list_libs
list_designs
...
# /* Write out report */
report_area > ./report/top_multpip_syn.report
report_timing -path full -delay max >> ./report/top_multpip_syn.report
report_power >> ./report/top_multpip_syn.report
report_power -analysis_effort medium -hierarchy -nosplit >> ./report/top_multpip_syn.report
report_cell > ./report/top_multpip_syn_cell.report
