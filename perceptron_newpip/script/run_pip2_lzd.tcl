...
# /* Write out report */
report_area > ./report/percep_syn_pip2_lzd.report
report_timing -path full -delay max >> ./report/percep_syn_pip2_lzd.report
report_power >> ./report/percep_syn_pip2_lzd.report
report_cell > ./report/percep_syn_cells_pip2_lzd.report
