...
# /* Read Verilog files */
analyze ./rtl -autoread -format verilog -define {LZA}
...
# /* Write out report */
report_area > ./report/percep_syn_pip2_lza_cec.report
report_timing -path full -delay max >> ./report/percep_syn_pip2_lza_cec.report
report_power >> ./report/percep_syn_pip2_lza_cec.report
report_cell > ./report/percep_syn_cells_pip2_lza_cec.report
