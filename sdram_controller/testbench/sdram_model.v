...
module sdram_model (Dq, Addr, Ba, Clk, Cke, Cs_n, Ras_n, Cas_n, We_n, Dqm);
...
`endif
            ...
            if (Dqm !== 2'b11) begin
                ...
                if (Debug) begin
                    $display("%m : at time %t WRITE: Bank = %d Row = %d, Col = %d, Data = %h", $time, Bank, Row[11:0], Col, Dq_dqm);
                end
            end else begin
                if (Debug) begin
...
`endif
            ...
            Dq_reg = #tAC Dq_dqm;
            if (Debug) begin
                $display("%m : at time %t READ : Bank = %d Row = %d, Col = %d, Dqm = %b, Data = %h", $time, Bank, Row[11:0], Col, Dqm_reg0, Dq_reg);
            end
