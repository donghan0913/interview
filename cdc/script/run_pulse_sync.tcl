...
set DEFINE_STR "PERIOD_SRC=$PERIOD_SRC_TICK PERIOD_DST=$PERIOD_DST_TICK"
...
# /* Write out report */
report_area > ./report/pulse_sync_syn.report
report_timing -path full -delay max >> ./report/pulse_sync_syn.report
report_power >> ./report/pulse_sync_syn.report
